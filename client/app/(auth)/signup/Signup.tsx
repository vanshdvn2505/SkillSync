  ...
  return (
    <div className="z-10 text-primary-foreground h-screen w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-transparent flex flex-col justify-center items-center ">
      ...
      <form className="lg:w-1/2 w-full mt-28" onSubmit={handleSubmit(onSubmit)}>
        ...
        <LabelInputContainer className="mb-4">
          <Label htmlFor="gender" className="text-accent">
            Gender
          </Label>
          <select
            id="gender"
            {...register("gender")}
            className="p-2 border border-accent rounded text-accent"
          >
            <option value="" className="text-accent">
              Select Gender
            </option>
            <option value="Male" className="text-accent">
              Male
            </option>
            <option value="Female" className="text-accent">
              Female
            </option>
            <option value="Other" className="text-accent">
              Other
            </option>
          </select>
          {errors.gender && (
        ...
        <LabelInputContainer className="mb-4">
          ...
          <select
            id="role"
            {...register("role")}
            className="p-2 border-accent border rounded text-accent"
          >
            <option value="" className="text-accent">
              Select Role
            </option>
            <option value="Mentor" className="text-accent">
              Mentor
            </option>
            <option value="Learner" className="text-accent">
              Learner
            </option>
          </select>
          {errors.role && (
        ...
        <button
          className="bg-primary relative group/btn block w-full text-primary-foreground rounded-md h-10 font-medium shadow-input"
          type="submit"
        >
          Sign up &rarr;
          <BottomGradient />
