...
export default function CommunityPage({ params }: { params: Promise<{ id: string, joined: boolean }> }) {
  return (
...
function CommunityPageContent({ params }: { params: Promise<{ id: string, joined: boolean }> }) {
  ...
  return (
    <div className="min-h-screen w-full bg-background">
      <Navbar />
      <CommunityHeader community={community} isJoined={unwrappedParams.joined} userId={user.id} />
