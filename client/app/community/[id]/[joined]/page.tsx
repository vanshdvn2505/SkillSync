...
export default function CommunityPage({ params }: { params: Promise<{ id: string, isJoined: boolean }> }) {
  return (
...
function CommunityPageContent({ params }: { params: Promise<{ id: string, isJoined: boolean }> }) {
