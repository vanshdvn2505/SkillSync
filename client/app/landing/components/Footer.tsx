...
const Footer = () => {
  return (
    <>
      <footer className="text-white w-full mt-10">
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <form className="w-full">
                  ...
                  >
                    <Input 
                      ...
                      className='lg:h-14 lg:text-xl md:h-10 md:text-md'
                    />
                    <Button
                      variant={'default'}
                      size={'lg'}
                      className='lg:h-14 text-lg border-border border-2'
                    >
                      Sign Up
                    </Button>
                  </div>
          ...
          <div className="mt-8 border-t border-gray-100 pt-8">
            <div className="sm:flex sm:justify-between">
              <p className="text-xs text-muted-foreground">&copy; 2025. SkillSync. All rights reserved.</p>

              <ul className="mt-8 flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end">
                <li>
                  <a href="#" className="text-muted-foreground transition hover:opacity-75"> Terms & Conditions </a>
                </li>

                <li>
                  <a href="#" className="text-muted-foreground transition hover:opacity-75"> Privacy Policy </a>
                </li>

                <li>
                  <a href="#" className="text-muted-foreground transition hover:opacity-75"> Cookies </a>
                </li>
              </ul>
            </div>
          </div>
